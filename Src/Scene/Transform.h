...
struct Transform
{
    ...
    glm::mat4 GetMatrix() const
    {
        ...
        glm::mat4 rotationX =
            glm::rotate(glm::mat4(1.0f), glm::radians(RotationEulerDegrees.x), glm::vec3(1.0f, 0.0f, 0.0f));
        glm::mat4 rotationY =
            glm::rotate(glm::mat4(1.0f), glm::radians(RotationEulerDegrees.y), glm::vec3(0.0f, 1.0f, 0.0f));
        glm::mat4 rotationZ =
            glm::rotate(glm::mat4(1.0f), glm::radians(RotationEulerDegrees.z), glm::vec3(0.0f, 0.0f, 1.0f));
