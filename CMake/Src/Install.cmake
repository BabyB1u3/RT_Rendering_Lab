install(CODE "
    ...
    set(stage_runtime \"${GLAB_STAGE_RUNTIME_NAME}\")
    set(stage_pak \"\${stage_dir}/Game.rtrpak\")
    set(stage_runtime_path \"\${stage_dir}/\${stage_runtime}\")

    if(NOT EXISTS \"\${stage_pak}\")
        message(FATAL_ERROR
            \"Missing packaged runtime content at '\${stage_pak}'. Build target 'rtrlab_stage_runtime' before running install.\")
    endif()

    if(NOT EXISTS \"\${stage_runtime_path}\")
        message(FATAL_ERROR
            \"Missing staged runtime at '\${stage_runtime_path}'. Build target 'rtrlab_stage_runtime' before running install.\")
    endif()
