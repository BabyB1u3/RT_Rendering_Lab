...
inline void WriteMountFileOrFail(const std::filesystem::path& mountRoot,
...
inline void WriteProjectFileOrFail(const std::filesystem::path& repoRoot,
                                   const std::filesystem::path& relativePath,
                                   std::string_view contents)
{
...
inline void WriteProjectBinaryFileOrFail(const std::filesystem::path& repoRoot,
                                         const std::filesystem::path& relativePath,
...
inline void WriteEngineFileOrFail(const std::filesystem::path& repoRoot,
                                  const std::filesystem::path& relativePath,
                                  std::string_view contents)
{
...
inline void WriteProjectCookedFileOrFail(const std::filesystem::path& cookedRoot,
                                         const std::filesystem::path& relativePath,
                                         std::string_view contents)
{
...
inline void WriteEngineCookedFileOrFail(const std::filesystem::path& cookedRoot,
                                        const std::filesystem::path& relativePath,
                                        std::string_view contents)
{
