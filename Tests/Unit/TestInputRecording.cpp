...
TEST_F(InputRecordingTests, RecorderBinaryRoundTripPreservesFrames)
{
    InputRecorder recorder;
    ...
    const auto path = test_support::CurrentTestPath("input-recording", "capture/input_recording.bin");
